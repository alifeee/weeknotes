...
- I made two new notes about
    - encrypting files https://blog.alifeee.net/notes/how-to-manually-encrypt-and-decrypt-a-file-or-folder/
    - uploading notes with a script https://blog.alifeee.net/notes/uploading-files-to-a-git-hub-repository-with-a-bash-script/
...
- I added some books to my ["favourite things" webpage](https://alifeee.net/favourites/)
