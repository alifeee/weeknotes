...
There are two large train station displays in the space. I have been eyeing them up for a few months, part of the interest from that I had [played with a bus station sign a few months ago](https://blog.alifeee.net/hull-bus-sign/).
...
This week I made a web component to switch the typeface of an element every N seconds. I put it on [GitHub](https://github.com/alifeee/font-toggler) and also made an [example page](https://alifeee.net/font-toggler/).
...
<https://liputenpo.org/> will soon be moved to point to <https://liputenpo.alifeee.net/>. I have been waiting for this for a while. This will also mean that I will spend some more time updating the new website, as it is actually being used.
...
I understate how much writing weeknotes counts as blogging, as I thought myself "not having written a blog post" in several months, because there wasn't one on <https://blog.alifeee.net/>. However, I think these should count more.
