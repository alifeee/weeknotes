...
I'm also back to using my phone, so I don't have a lovely [automatic table of contents generator](https://markdown-all-in-one.github.io/docs/guide/table-of-contents.html). Time to find a weird online web tool... done! 
