...
I spent most, if not all, of Tuesday prepping my [font talk](https://alifeee.net/font-talk/). I had already listed the content in the format of nested bullet points over the previous week and a half, so it was a day of finding images, and laying out content on [the slides](https://alifeee.net/font-talk/).
...
[Font talk](https://alifeee.net/font-talk) complete.
