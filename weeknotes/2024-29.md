...
Then, with the desire of creating a shareable link, I read the FAQ for <https://geojson.io/>, which suggested hosting a `geoJSON` file on a GitHub Gist. Now, [I love GitHub gists](https://blog.alifeee.net/gists/), so I did just that, and...
