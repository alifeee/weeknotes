...
Thanks to my [latest blog post](https://blog.alifeee.net/railcards/), I naturally knew *everything there is to know* about the 16-25 railcard. I bought a new one.
...
[Liverpool MakeFest](https://liverpoolmakefest.org/) is a wonderful collection of people, ideas, and intriguing objects. I am writing a small blog post about it with a friend, so I shan't go into any detail here. You will have to subscribe to my blog's [RSS feed](https://blog.alifeee.net/feed.xml) to be notified when you can read about that.
...
It currently stands at second on my favourite mobile games on my [bookmarks list](https://alifeee.net/bookmarks/). I might have to move it to first.
