...
- [attempts to make a local archive of personal websites](https://blog.alifeee.net/notes/attempts-to-make-a-local-archive-of-personal-websites/)
- [comparing PCs with terminal commands](https://blog.alifeee.net/notes/comparing-pcs-with-terminal-commands/)
- [a Nautilus script to create blank files in a folder](https://blog.alifeee.net/notes/a-nautilus-script-to-create-blank-files-in-a-folder/)
- [combining geojson files with jq](https://blog.alifeee.net/notes/combining-geojson-files-with-jq/)
- [installing my own VPN on my server was much easier than I thought](https://blog.alifeee.net/notes/installing-my-own-vpn-on-my-server-was-much-easier-than-i-thought/)
